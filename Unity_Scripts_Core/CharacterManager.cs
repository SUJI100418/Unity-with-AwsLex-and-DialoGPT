...
public class CharacterManager : MonoBehaviour
{
    ...
    [SerializeField]
    private CharacterMoods _foxMoods;

    [SerializeField]
    private CharacterMoods _hunterMoods;
    ...
    public void ShowCharacter(CharacterName name, CharacterPosition position, CharacterMood mood)
    {
        ...
        Debug.Log($"ShowCharacter : {name}, {mood}");
    ...
    public void ChangeMood(CharacterName name, CharacterMood mood)
    {
        ...
        {
            Debug.Log($"ChangeModd : {name}, {mood}");
